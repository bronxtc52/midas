...
**Статус (2026-07-03, вечер):** v1 ПОСТРОЕН и работает на mh-central (docker compose,
проект `midas`). Спека реконструирована и утверждена (`docs/specs/midas-v1.md`),
Конституция v1.1 (`docs/constitution.md`), демон+роли реализованы (этапы 0–6,
~55 тестов), **два E2E-цикла пройдены насквозь** (issues #2/#4 → PR #3/#5 → ACCEPT).
Операции — `docs/runbook.md`. Хвосты — issues #6–#9 (Sentry, fine-grained PAT,
Council, DoD в Acceptor).
